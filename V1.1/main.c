...
#pragma config(Motor,  port4,           driveR2,       tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_2)
...
#pragma config(Motor,  port7,           driveL2,       tmotorVex393_MC29, openLoop, encoderPort, I2C_1)
