...
#pragma config(Sensor, in1,    armPotR,        sensorPotentiometer)
...
#pragma config(Motor,  port4,           driveL2,       tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port5,           driveR1,       tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port6,           driveL1,       tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port7,           driveR2,       tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_1)
