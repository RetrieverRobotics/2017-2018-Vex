...
////////////////////////////////mogo 1
  ...
  tardLift(LIFT_AUTON_FLOOR_HOLD);
...
else if (autonSelection == RAM_AUTON){
  tankDrive(127,127);
  wait1Msec(5000);
  tankDrive(0,0);
}
